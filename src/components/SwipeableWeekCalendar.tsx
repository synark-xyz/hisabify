...
export function SwipeableWeekCalendar({
    ...
    return (
        <div className="relative overflow-hidden bg-card rounded-2xl p-4 shadow-card">
            {/* Day Labels */}
            ...
            <div className="flex justify-between items-center mt-2 px-1 opacity-20 pointer-events-none">
                <ChevronLeft className="w-4 h-4" />
                <span className="text-[10px]">Swipe for more</span>
