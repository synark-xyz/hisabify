    ...
    <div className="min-h-screen bg-transparent pb-page-content fade-bottom-overlay">
      <div className="max-w-md mx-auto">
        <main className="px-4 space-y-6 pt-4">
          {/* Profile Card */}
          <motion.div
            className="bg-card rounded-2xl p-6 shadow-card text-center relative pointer-events-none"
          ...
          >
            {menuItems.map((item, idx) => (
              <motion.div
                ...
                className="flex items-center justify-between p-4 bg-card rounded-2xl border border-border/50 cursor-pointer hover:bg-muted/50 transition-colors shadow-sm"
                whileTap={{ scale: 0.98 }}
              >
